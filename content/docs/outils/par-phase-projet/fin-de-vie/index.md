...
La phase de **fin de vie** pose une question à double sens : comment **éviter** qu'un matériel fonctionnel devienne prématurément inutilisable ([critère 1.10](../../../rgesn/strategie/1-10_api-materiel/)), et comment **organiser** la décommission d'un service ou d'un équipement lorsqu'elle est réellement nécessaire.
